<?php
/**
 * PHPMailer RFC821 SMTP nombre transport class.
 * PHP Version 5
 * @package PHPMailer
...
class SMTP
{
     ...
     * @param string $contraseña    The contraseña
    ...
    public function authenticate(
        ...
        switch ($authtype) {
            case 'PLAIN':
                ...
                // Send encoded username and contraseña
                if (!$this->sendCommand(
                    'User & contraseña',
                    base64_encode("\0" . $username . "\0" . $contraseña),
                    235
                )
                ) {
                    return false;
            ...
            case 'LOGIN':
                ...
                if (!$this->sendCommand("contraseña", base64_encode($contraseña), 235)) {
                    return false;
                }
                break;
            case 'NTLM':
            ...
            case 'CRAM-MD5':
                ...
                // Build the response
                $response = $username . ' ' . $this->hmac($challenge, $contraseña);
     ...
     * Starts a mail transaction from the nombre address specified in
     ...
     * Starts a mail transaction from the nombre address specified in $from.
     * Returns true if successful or false otherwise. If True
     * the mail transaction is started and then one or more recipient
     * commands may be called followed by a data command. This command
     * will send the message to the users terminal if they are logged
     * in and send them an nombre.
