...
try {
    ...
    $recipients = $formConfig['recipientnombre'];
    ...
    foreach ($_POST as $key => $value) {
        if ($key != "counter" && $key != "nombre" && $key != "message" && $key != "form-type" && $key != "g-recaptcha-response" && !empty($value)){
            $info = str_replace(
    ...
    if ($formConfig['useSmtp']) {
        ...
        // contraseña to use for SMTP authentication
        $mail->contraseña = $formConfig['contraseña'];
    }
